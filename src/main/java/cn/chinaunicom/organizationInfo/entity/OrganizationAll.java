...
public class OrganizationAll extends Model<OrganizationAll> {
	...
	public void setOrganizationIdParent(int organizationIdParent) {
		this.organizationIdParent = organizationIdParent;
	}
	...
	public String toString() {
		return "OrganizationAll{" + ", organizationId=" + organizationId + ", name=" + name + ", type=" + type + ", subCount=" + subCount + ", lev=" + lev + ", organizationIdParent="
				+ organizationIdParent + ", dateFrom=" + dateFrom + ", dateTo=" + dateTo + ", cncOrgSortCode=" + cncOrgSortCode + ", cncSouthNorth=" + cncSouthNorth + ", cncCunxuShiye="
				+ cncCunxuShiye + ", cncOrgProvince=" + cncOrgProvince + ", cncBranchName=" + cncBranchName + ", cncOrgCode=" + cncOrgCode + ", cncDisableDate=" + cncDisableDate + ", cncOrgLevel="
				+ cncOrgLevel + ", cncVirtualOrg=" + cncVirtualOrg + ", cncOrgFullname=" + cncOrgFullname + ", org1=" + org1 + ", org2=" + org2 + ", org3=" + org3 + ", org4=" + org4 + ", org5=" + org5
				+ ", org6=" + org6 + ", org7=" + org7 + ", org8=" + org8 + ", org9=" + org9 + ", org10=" + org10 + ", createBy=" + createBy + ", createDate=" + createDate + ", updateBy=" + updateBy
				+ ", updateDate=" + updateDate + ", attribute1=" + attribute1 + ", attribute2=" + attribute2 + ", attribute3=" + attribute3 + ", attribute4=" + attribute4 + ", attribute5="
				+ attribute5 + ", attribute6=" + attribute6 + ", attribute7=" + attribute7 + ", attribute8=" + attribute8 + ", attribute9=" + attribute9 + ", attribute10=" + attribute10
				+ ", attribute11=" + attribute11 + ", attribute12=" + attribute12 + ", attribute13=" + attribute13 + ", attribute14=" + attribute14 + ", attribute15=" + attribute15 + ", attribute16="
				+ attribute16 + ", attribute17=" + attribute17 + ", attribute18=" + attribute18 + ", attribute19=" + attribute19 + ", attribute20=" + attribute20 + ", cucOrgMin=" + cucOrgMin
				+ ", cugOrgLob=" + cugOrgLob + ", businessGroupId=" + businessGroupId + ", cucOriOrgId=" + cucOriOrgId + ", cucNewOrgId=" + cucNewOrgId + "}";
	}
}
